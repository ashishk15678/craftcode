                    ...
                    <div class="min-h-[300px] flex flex-col">
                        {#if currentStep === 0}
                            ...
                            >
                                ...
                                <h2
                                    class="text-2xl font-bold text-foreground my-2"
                                >
                                ...
                                >
                                    You're about to embark on a journey to
                                    master programming by building real-world
                        ...
                        {:else if currentStep === 2}
                            ...
                            >
                                ...
                                <p
                                    class="text-muted-foreground max-w-sm mx-auto mb-6"
                                >
                                    Start by exploring challenges or create your
                                    own in the Creator Studio.
                                </p>
                                <div
